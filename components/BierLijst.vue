          ...
          <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
            ...
            <table v-if="page === 'Main'" class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tr>
                ...
                <th v-if="isLoggedIn" scope="col" class="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                  Beoordelen
                </th>
              ...
              <tr v-for="beer in beers" :key="beer.id">
                ...
                <td v-if="isLoggedIn" class="px-4 py-4 text-sm whitespace-nowrap">


                  <div class="flex items-center">
                    <button v-for="index in 5"
                            :key="'Star-' + index"
                            @click="rateBeer(index, beer.id)"
